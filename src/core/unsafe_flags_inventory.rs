...
//! | `PLATARIUM_CORE_RPC_INSECURE` | [`rpc_security`](crate::core::rpc_security) / serve ACL | off | **Core** | Disables RPC token ACL (local tests only). **Refused** for multi-node Melancholy at serve (#49); **any** multi-node + insecure also refused at serve / authorize because it opens remote sign/keygen (#50 / #110). |
